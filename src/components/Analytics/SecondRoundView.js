...
import img from '../../assets/img/macronVsLePen.png'
import { useIntl } from 'react-intl';

function SecondRoundView() {
  const intl = useIntl();
  return (
    <Container className='secondRound' >
                
            
        <h4 >  {intl.formatMessage({ id: 'candidatesTitle' })} </h4> 
        <h6>  {intl.formatMessage({ id: 'SecondRoundInfo' })} </h6>  

        <div className="tweet-wrap">
            <div className="tweet-header">
                <img src={member3} alt="" className="avator"/>
                <div className="tweet-header-info">
                Romaissa KESSI <span>@romaissakessi</span><span>. Apr 16 </span>
                <p>Thank you for being patient. We are doing some work on the second round ads statistics. Stay tuned 🔥</p>  
                </div> 
            </div>
        ...
        <div className="tweet-info-counts">
            ...
            <div className="retweet-count">4</div>
            </div>
